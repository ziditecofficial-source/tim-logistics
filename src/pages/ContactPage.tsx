      ...
      <section className="container py-16 grid lg:grid-cols-2 gap-10">
        ...
        <div className="bg-gradient-primary text-primary-foreground rounded-3xl p-8 md:p-10 shadow-card">
          ...
          <div className="grid gap-3 mt-6">
            <a href="https://play.google.com/store/apps/details?id=com.tim_logistics.app" target="_blank" rel="noreferrer" className="px-5 py-3 rounded-2xl bg-background/15 hover:bg-background/25 transition-smooth">▶ TIM ({t("dl.users.tag")}) — Google Play</a>
            <a href="https://apps.apple.com/us/app/tim-logistic/id6745712258" target="_blank" rel="noreferrer" className="px-5 py-3 rounded-2xl bg-background/15 hover:bg-background/25 transition-smooth"> TIM ({t("dl.users.tag")}) — App Store</a>
            <a href="https://play.google.com/store/apps/details?id=com.afrovisiongroup.tim_agent_app" target="_blank" rel="noreferrer" className="px-5 py-3 rounded-2xl bg-background/15 hover:bg-background/25 transition-smooth">▶ TIM Agent — Google Play</a>
            <a href="https://apps.apple.com/us/app/tim-agent/id6745712376" target="_blank" rel="noreferrer" className="px-5 py-3 rounded-2xl bg-background/15 hover:bg-background/25 transition-smooth"> TIM Agent — App Store</a>
          </div>
        </div>
      </section>
    </SiteLayout>
